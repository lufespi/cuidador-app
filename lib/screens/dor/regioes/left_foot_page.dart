...
class LeftFootPage extends StatefulWidget {
  ...
  static const String _chaveRegiao = 'Pé E.';
...
class _LeftFootPageState extends State<LeftFootPage> {
  ...
  void initState() {
    super.initState();
    if (LeftFootPage._selecoesSalvas.containsKey(LeftFootPage._chaveRegiao)) {
      _pontosSelecionados.addAll(LeftFootPage._selecoesSalvas[LeftFootPage._chaveRegiao]!);
    }
  }

  void _salvarSelecoes() {
    LeftFootPage._selecoesSalvas[LeftFootPage._chaveRegiao] = List.from(_pontosSelecionados);
  }
  
  // Pontos fixos clicáveis
  final List<Map<String, dynamic>> _pontosFixos = [
    {'xPercent': 59.70, 'yPercent': 89.88, 'label': 'Ponto 1'},
    {'xPercent': 66.18, 'yPercent': 90.93, 'label': 'Ponto 2'},
    {'xPercent': 71.86, 'yPercent': 90.26, 'label': 'Ponto 3'},
    {'xPercent': 76.76, 'yPercent': 89.19, 'label': 'Ponto 4'},
    {'xPercent': 82.08, 'yPercent': 86.87, 'label': 'Ponto 5'},
    {'xPercent': 31.83, 'yPercent': 11.69, 'label': 'Ponto 6'},
    {'xPercent': 27.36, 'yPercent': 56.64, 'label': 'Ponto 7'},
    {'xPercent': 52.69, 'yPercent': 69.44, 'label': 'Ponto 8'},
  ];
